...
errval_t vfs_read(void *st, ramfs_handle_t handle, void *buffer, size_t bytes, size_t *bytes_read);

errval_t vfs_write(void *st, ramfs_handle_t handle, void *buffer, size_t bytes, size_t *bytes_written);
